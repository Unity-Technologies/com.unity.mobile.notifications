...
namespace Unity.Notifications.Tests.Sample
{
    public class iOSTest : MonoBehaviour
    {
        ...
        private void InstantiateAllTestButtons()
        {
            ...
            groups["Cancellation"]["Cancel scheduled notifications"] =
                new Action(() => { RemoveScheduledNotifications(); });
            groups["Cancellation"]["Cancel delivered notifications"] =
            ...
            foreach (KeyValuePair<string, OrderedDictionary> group in groups)
            {
                ...
                Transform buttonGroup =
                    GameObject.Instantiate(gameObjectReferences.buttonGroupTemplate, gameObjectReferences.buttonScrollViewContent);
