...
namespace Unity.Notifications.iOS
{
    ...
    public class iOSNotification
    {
        ...
        /// Push notification is sent to the device as [JSON](https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/generating_a_remote_notification?language=objc). The value for `data` key is set to the `Data` property on notification.
        /// </summary>
        public string Data
        {
            get
